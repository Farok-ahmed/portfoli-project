...
<section class="page-banner-area pt-200 rpt-140 pb-100 rpb-60 rel z-1 text-center">
    <div class="container">
        <div class="banner-inner text-white">
            <h1 class="page-title wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;"> Blog Standard</h1>
...
<section class="blog-standard-area pb-70 rpb-40 pb-130 rpb-100 rel z-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-standard-wrap" style="position: relative; height: 2437.13px;">
                    <div class="row">
                        <div class="col-md-6 item" style="position: absolute; left: 0px; top: 0px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 425px; top: 0px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-4s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 0px; top: 557.033px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 425px; top: 588.033px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-4s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 0px; top: 1114.07px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 425px; top: 1176.07px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-4s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 0px; top: 1671.1px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item" style="position: absolute; left: 425px; top: 1764.1px;">
                            <div class="blog-item style-two wow fadeInUp delay-0-4s animated" style="visibility: visible; animation-name: fadeInUp;">
                                <div class="image">
                        ...
                        <div class="col-md-6 item offset-md-6" style="position: absolute; left: 0px; top: 2352.13px;">
                            <div class="news-more-btn text-center mt-35 wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <div class="col-lg-4">
                <div class="main-sidebar rmt-65">
                    ...
                    <div class="widget widget-recent-news wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div class="widget widget-cta wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
