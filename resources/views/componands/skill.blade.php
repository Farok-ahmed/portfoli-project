                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-2s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill1.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-3s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill2.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-4s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill3.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-5s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill4.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-2s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill5.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-3s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill6.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-4s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill7.png" alt="Skill">
                                    <h5>Figma</h5>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="skill-item wow fadeInUp delay-0-5s">
                                    <img src="{{ asset('fontend') }}/images/skills/skill8.png" alt="Skill">
                                    <h5>Figma</h5>
